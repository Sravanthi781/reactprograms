...
function Milk() {
  let milkProducts = useSelector((globalState) => globalState.products.Milk);
  ...
  // ✅ Offers List for Milk
  const offers = [
    {
      message: "🥛 Buy 1 Get 1 Free on Milk Packets!",
      image: "https://img.icons8.com/color/48/milk-bottle.png",
      endDate: "2025-09-30"
    },
    {
      message: "🧈 15% Off on Butter!",
      image: "https://img.icons8.com/color/48/butter.png",
      endDate: "2025-09-28"
    },
    {
      message: "🧀 Special Discount on Cheese!",
  ...
  return (
    <div className="milk-page mt-4 position-relative">
      ...
      <h2 className="text-center mb-4">🥛 Quality Milk Products – Healthy Living, Happy Life</h2>
